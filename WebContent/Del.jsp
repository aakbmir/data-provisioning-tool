...
<%}%>
	...
	function enableContinueButton() {
		...
		if (firstName.length > 0 && lastName.length > 0) {
			...
			document.getElementById('forgotUsername').style.backgroundColor = 'green';
		} else {
			document.getElementById('forgotUsername').disabled = true;
...
<body onload="onload();refresh();Clear();"
	...
	<div
		...
		<form autocomplete="off" action="RegisterServlet" method="post">
			<div id="signUpDiv"
				style="top: 35%; border-radius: 10px; background-color: cadetblue; float: left; width: 50%; position: absolute; height: 55%; padding: 10px; left: 70%; text-align: center; display: block;">

				<table style="width: 50%;position: absolute;left: 25%;">
					<tr>
						<td
					...
					<tr>
						<td style="text-align: left;height:35px"><span id="FirstNameError"
							style="line-height: 1px; color: red"> First Name cannot be
								null</span></td>
					</tr>
					<tr>
						<td style="text-align: left;"><input autocomplete="off"
					...
					<tr>
						<td style="text-align: left;height:35px"><span id="LastNameError"
							style="line-height: 1px; color: red">Last Name cannot be
								null</span></td>
					</tr>
					<tr>
						<td style="text-align: left;"><input autocomplete="off"
					...
					<tr>
						<td style="text-align: left;height:35px"><span id="SignUpUserNameError"
							style="line-height: 1px; color: red">Username cannot be
								null</span></td>
					</tr>
					<tr>
 ...
 %> <span id="" style="line-height: 25px; color: red; font-size: 18px;">
								<%
 ...
 %>
		...
		<form autocomplete="off" action="AuthenticationServlet" method="post">
			<div id="signInDiv"
				style="border-radius: 5px;background-color: cadetblue;float: left;width: 45%;position: absolute;height: 20%;padding: 10px;left: 75%;text-align: center;display: block;">

				<table style="width: 95%; position: absolute; left: 5%;">
					<tr>
						<td
					...
					<tr>
						<td style="text-align: left; width: 33%;"><input
							autocomplete="off" class="search-tx" type="text"
							name="signInUserName" id="signInUserName"
							style="outline: none; border-radius: 5px; border: none; height: 35px; width: 85%; background-color: cornsilk; color: black; padding: 0px 6px; font-size: 16px;"
							placeholder="Username"></td>
						<td style="width: 33%;"><select name="env"
							style="outline: none; border-radius: 5px; border: none; height: 35px; width: 85%; background-color: cornsilk; color: black; padding: 0px 6px; font-size: 16px;">
								<option style="color: white; opacity: 0.8;">PIPE-C</option>
								<option>PIPE-D</option>
						</select></td>
						<td style="width: 33%;"><input type="submit" id="signin"
 ...
 %> <span id="signInUserNameError"
							style="line-height: 1px; color: red; font-size: 18px;"> <%
 ...
 %></td>
			...
			<div id="forgotDiv"
				style="float: right; width: 70%; position: absolute; top: 20%; height: 64%; padding: 10px; left: 14%; text-align: center; display: block;">
				<table border="0" style="width: 100%">
					<tr style="height: 80px">
						<td
							style="text-align: left; font-weight: bold; font-size: 22px; width: 30%">Forgot
							Password</td>
						<td style="text-align: right; width: 60%"><a href="#"
							style="font-size: 18px; color: green; font-weight: bold;"
							onclick="return ForgotUsernameScreen('loginButton');">Cancel
								and return to Log in</a></td>
					</tr>
					<tr style="height: 15px">
						<td style="text-align: left; color: red; width: 30%">*
							Denotes Required Field</td>
						<td style="text-align: right; color: red; width: 60%"></td>
					</tr>
					<tr style="height: 80px;">
						<td style="text-align: left; font-size: 20px; font-weight: bold;">First
							Name</td>
						<td><input autocomplete="off" type="text"
							onkeyup="enableContinueButton()" id="forgetfirstName"
							name="forgetfirstName"
							style="outline: none; border-radius: 18px; border: none; height: 43px; width: 240px; background-color: rgb(47, 54, 64); color: white; padding: 0px 6px; font-size: 16px;"
							placeholder="*"></td>
					<tr style="height: 80px;">
						<td style="text-align: left;; font-size: 20px; font-weight: bold;">Last
							Name</td>
						<td><input autocomplete="off" type="text" id="forgetlastName"
							name="forgetlastName" onkeyup="enableContinueButton()"
							style="outline: none; border-radius: 18px; border: none; height: 43px; width: 240px; background-color: rgb(47, 54, 64); color: white; padding: 0px 6px; font-size: 16px;"
							placeholder="*"></td>
					</tr>
					<tr style="height: 80px;">
						<td colspan="2"><input type="submit" id="forgotUsername"
							value="Continue" name="forgotUsername"
							style="outline: none; cursor: pointer; border-radius: 18px; border: none; height: 43px; width: 130px; background-color: transparent; color: white; padding: 0px 6px; font-size: 16px;">
						</td>
					</tr>
					<tr>
